...
public class GameMgr : MonoBehaviour
{
    ...
    {
        TryToShowTipFingers("Green_Tree_4");
        TryToShowTipFingers("Fruit_Peach");
        TryToShowTipFingers("Dreamflower_1");
        TryToShowTipFingers("Dreamflower_2");
        TryToShowTipFingers("Dreamflower_3");
        TryToShowTipFingers("Dreamflower_4");
    }
    ...
    public void TryToShowTipFingers(string prefabName)
    {
        ...
        if (prefabName == "Green_Tree_4" && ObjectForDraw.DrawnObjectLists[def][0].addctiveObject != null)
        {
        ...
        {
            if (prefabName == "Fruit_Peach" && GridCellsMgr.Instance.cells[6][3].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
        ...
        {
            if (prefabName == "Fruit_Peach" && GridCellsMgr.Instance.cells[3][3].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
            ...
            if (prefabName == "Dreamflower_1" && GridCellsMgr.Instance.cells[4][3].Dead)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def].Find(item => item.deathComponent == null);
                GridCell target;
            ...
            if (prefabName == "Dreamflower_4" && GridCellsMgr.Instance.cells[6][8].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
    ...
    public void UnfogATile_ClearAt(Fog fog,bool forcePlayAudio = false)
    {
        ...
        if (GameMgr.Instance.isLandScape)
        {
            if (fog.indexX == 8 && fog.indexY == 3)
            {
                ...
                cell.IsKeyhole = true;
                cell.keyObjectDefinitionPrefabName = "Dreamflower_4";
                GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("Dreamflower_4", new Vector3(cell.transform.position.x, cell.transform.position.y, 5));
    ...
    public void InitFirstKeyHole()
    {
        if (GameMgr.Instance.isLandScape)
        {
            ...
            cell.keyObjectDefinitionPrefabName = "Fruit_Peach";
            GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("Fruit_Peach", new Vector3(cell.transform.position.x, cell.transform.position.y, 10));
