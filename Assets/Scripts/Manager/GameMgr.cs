...
public class GameMgr : MonoBehaviour
{
    ...
    {
        TryToShowTipFingers("MonsterHouse_6");
        TryToShowTipFingers("Key_Cloud_Dungeon");
        TryToShowTipFingers("Princess_Crimson_0");
        TryToShowTipFingers("Princess_Crimson_1_Root");
        TryToShowTipFingers("Princess_Crimson_3_Root");
        TryToShowTipFingers("Princess_Crimson_4_Root");
    }
    ...
    public void TryToShowTipFingers(string prefabName)
    {
        ...
        if (prefabName == "MonsterHouse_6" && ObjectForDraw.DrawnObjectLists[def][0].addctiveObject != null)
        {
        ...
        if (GameMgr.Instance.isLandScape)
        {
            ...
            if (prefabName == "Princess_Crimson_0" && GridCellsMgr.Instance.cells[5][4].Dead)
            {
            ...
            if (prefabName == "Princess_Crimson_4_Root" && GridCellsMgr.Instance.cells[8][3].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
        ...
        else
        {
            ...
            if (prefabName == "Princess_Crimson_0" && GridCellsMgr.Instance.cells[4][3].Dead)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def].Find(item => item.deathComponent == null);
                GridCell target;
            ...
            if (prefabName == "Princess_Crimson_4_Root" && GridCellsMgr.Instance.cells[6][8].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
    ...
    public void UnfogATile_ClearAt(Fog fog,bool forcePlayAudio = false)
    {
        ...
        if (GameMgr.Instance.isLandScape)
        {
            if (fog.indexX == 8 && fog.indexY == 3)
            {
                ...
                cell.IsKeyhole = true;
                cell.keyObjectDefinitionPrefabName = "Princess_Crimson_4_Root";
                GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("Princess_Crimson_4_Root", new Vector3(cell.transform.position.x, cell.transform.position.y, 4.6f));
