...
public class GameMgr : MonoBehaviour
{
    ...
    {
        TryToShowTipFingers("Seed_FruitTree");
        TryToShowTipFingers("Green_Tree_1");
        TryToShowTipFingers("Green_Tree_2");
        TryToShowTipFingers("Green_Tree_3");
    ...
    public void TryToShowTipFingers(string prefabName)
    {
        ...
        {
            if (prefabName == "Green_Tree_1" && GridCellsMgr.Instance.cells[6][1].KeyObject != null)
            {
        ...
        {
            if (prefabName == "Green_Tree_1" && GridCellsMgr.Instance.cells[2][1].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
    ...
    public void InitFirstKeyHole()
    {
        if (GameMgr.Instance.isLandScape)
        {
            ...
            cell.keyObjectDefinitionPrefabName = "Green_Tree_1";
            GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("Green_Tree_1", new Vector3(cell.transform.position.x, cell.transform.position.y, 2.4f));
        ...
        else
        {
            ...
            cell.keyObjectDefinitionPrefabName = "Green_Tree_1";
            GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("Green_Tree_1", new Vector3(cell.transform.position.x, cell.transform.position.y, 1.8f));
