...
public class GameMgr : MonoBehaviour
{
    ...
    {
        TryToShowTipFingers("Hero_MagicTome");
        TryToShowTipFingers("Key_Cloud_Dungeon");
        TryToShowTipFingers("Treasure_Chest");
        TryToShowTipFingers("Treasure_Chest_2");
        TryToShowTipFingers("Treasure_Chest_3");
        TryToShowTipFingers("Treasure_Chest_5");
    }
    ...
    public void TryToShowTipFingers(string prefabName)
    {
        ...
        if (prefabName == "Hero_MagicTome" && ObjectForDraw.DrawnObjectLists[def][0].addctiveObject != null)
        {
            selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
            tipFinger_0.SetActive(true);
            GameMgr.Instance.tipFinger_0.transform.position = selector_Start_0.Position2D;
        ...
        {
            if (prefabName == "Key_Cloud_Dungeon" && GridCellsMgr.Instance.cells[6][3].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
            ...
            if (prefabName == "Treasure_Chest" && GridCellsMgr.Instance.cells[5][4].Dead)
            {
            ...
            if (prefabName == "Treasure_Chest_5" && GridCellsMgr.Instance.cells[8][3].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
                GridCell target = GridCellsMgr.Instance.cells[8][3];
                if (target == null) return;
                tipFinger_0.SetActive(true);
                ObjectAnim.StartMoveAndScaleAnimation(GameMgr.Instance.tipFinger_0, new Vector2(selector_Start_0.Position2D.x, selector_Start_0.Position2D.y), target.Center);
                showTip = true;
                return;
            }
        }
        ...
        {
            if (prefabName == "Key_Cloud_Dungeon" && GridCellsMgr.Instance.cells[3][3].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
            ...
            if (prefabName == "Treasure_Chest" && GridCellsMgr.Instance.cells[4][3].Dead)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def].Find(item => item.deathComponent == null);
                GridCell target;
                if (GridCellsMgr.Instance.cells[4][3].Dead) target = GridCellsMgr.Instance.cells[3][3];
                else target = null;
                if (target == null) return;
                tipFinger_0.SetActive(true);
                ObjectAnim.StartMoveAndScaleAnimation(GameMgr.Instance.tipFinger_0, selector_Start_0.Position2D, target.Center);
            ...
            if (prefabName == "Treasure_Chest_5" && GridCellsMgr.Instance.cells[6][8].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
                GridCell target = GridCellsMgr.Instance.cells[6][8];
                if (target == null) return;
                tipFinger_0.SetActive(true);
                ObjectAnim.StartMoveAndScaleAnimation(GameMgr.Instance.tipFinger_0, new Vector2(selector_Start_0.Position2D.x, selector_Start_0.Position2D.y), target.Center);
                showTip = true;
    ...
    public void UnfogATile_ClearAt(Fog fog,bool forcePlayAudio = false)
    {
        ...
        if (GameMgr.Instance.isLandScape)
        {
            if (fog.indexX == 8 && fog.indexY == 3)
            {
                GridCell cell = GridCellsMgr.Instance.cells[fog.indexX][fog.indexY];
                cell.IsKeyhole = true;
                cell.keyObjectDefinitionPrefabName = "Treasure_Chest_5";
                GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("Treasure_Chest_5", new Vector3(cell.transform.position.x, cell.transform.position.y, 4.6f));
    ...
    public void InitFirstKeyHole()
    {
        if (GameMgr.Instance.isLandScape)
        {
            GridCell cell = GridCellsMgr.Instance.cells[6][3];
            cell.keyObjectDefinitionPrefabName = "Key_Cloud_Dungeon";
            GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("Key_Cloud_Dungeon", new Vector3(cell.transform.position.x, cell.transform.position.y, 10));
        ...
        {
            GridCell cell = GridCellsMgr.Instance.cells[3][3];
            cell.keyObjectDefinitionPrefabName = "Key_Cloud_Dungeon";
            GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("Key_Cloud_Dungeon", new Vector3(cell.transform.position.x, cell.transform.position.y, 10));
    ...
    public void AdjustCameraSize()
    {
        ...
        {
            var targetSize = basicSize * (targetAspect / currentAspect);
        ...
        {
            cam.orthographicSize = basicSize; // 默认大小
        }
    ...
    private void LateUpdate()
    {
        ...
        if(startClearFogs_0)
        {
            for (int i = 0; i < fogs_0.Count; i++)
            {
                if (fogs_0 != null && fogs_0.Count != 0)
                {
                    UnfogATile_ClearAt(fogs_0[0]);
