...
public class GameMgr : MonoBehaviour
{
    ...
    {
        TryToShowTipFingers("LivingStone_1");
        TryToShowTipFingers("LivingStone_2");
        TryToShowTipFingers("LivingStone_3");
        TryToShowTipFingers("LivingStone_4");
        TryToShowTipFingers("Hero_Rainbow");
        TryToShowTipFingers("Life_Orb_4_Root");
    }
    ...
    public void TryToShowTipFingers(string prefabName)
    {
        ...
        {
            if (prefabName == "LivingStone_2" && GridCellsMgr.Instance.cells[6][1].KeyObject != null)
            {
            ...
            if (prefabName == "Life_Orb_4_Root" && GridCellsMgr.Instance.cells[6][3].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
        ...
        {
            if (prefabName == "LivingStone_2" && GridCellsMgr.Instance.cells[2][1].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
            ...
            if (prefabName == "Life_Orb_4_Root" && GridCellsMgr.Instance.cells[3][3].KeyObject != null)
            {
                selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
        ...
        if (prefabName == "Hero_Rainbow" && ObjectForDraw.DrawnObjectLists[def][0].addctiveObject != null)
        {
            selector_Start_0 = ObjectForDraw.DrawnObjectLists[def][0];
            tipFinger_0.SetActive(true);
    ...
    public void UnfogATile_ClearAt(Fog fog,bool forcePlayAudio = false)
    {
        ...
        if (GameMgr.Instance.isLandScape)
        {
            if (fog.indexX == 6 && fog.indexY == 3)
            {
                ...
                cell.IsKeyhole = true;
                cell.keyObjectDefinitionPrefabName = "Life_Orb_4_Root";
                GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("Life_Orb_4_Root", new Vector3(cell.transform.position.x, cell.transform.position.y, 3));
    ...
    public void InitFirstKeyHole()
    {
        if (GameMgr.Instance.isLandScape)
        {
            ...
            cell.keyObjectDefinitionPrefabName = "LivingStone_2";
            GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("LivingStone_2", new Vector3(cell.transform.position.x, cell.transform.position.y, 2.4f));
        ...
        else
        {
            ...
            cell.keyObjectDefinitionPrefabName = "LivingStone_2";
            GameObject tgameObject = GameMgr.GenerateFromPrefabAtPrincess("LivingStone_2", new Vector3(cell.transform.position.x, cell.transform.position.y, 1.8f));
