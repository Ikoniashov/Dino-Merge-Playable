...
public class GridCellsMgr : MonoBehaviour
{
    ...
    public void LoadEntities()
    {
        if (GameMgr.Instance.isLandScape)
        {
            LoadEntitiesCellFromMapDataPrincess("GoldenSeeds", 6, 0);
            LoadEntitiesCellFromMapDataPrincess("GoldenSeeds", 7, 0);
            LoadEntitiesCellFromMapDataPrincess("GoldenSeeds", 5, 1);
        }
        else
        {
            LoadEntitiesCellFromMapDataPrincess("GoldenSeeds", 2, 0);
            LoadEntitiesCellFromMapDataPrincess("GoldenSeeds", 1, 1);
            LoadEntitiesCellFromMapDataPrincess("GoldenSeeds", 3, 0);
        }
