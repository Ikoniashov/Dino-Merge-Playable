...
public class GridCellsMgr : MonoBehaviour
{
    ...
    public void LoadEntities()
    {
        if (GameMgr.Instance.isLandScape)
        {
            LoadEntitiesCellFromMapDataPrincess("LivingStone_1", 6, 0);
            LoadEntitiesCellFromMapDataPrincess("LivingStone_1", 7, 0);
            LoadEntitiesCellFromMapDataPrincess("LivingStone_1", 5, 1);
        }
        else
        {
            LoadEntitiesCellFromMapDataPrincess("LivingStone_1", 2, 0);
            LoadEntitiesCellFromMapDataPrincess("LivingStone_1", 1, 1);
            LoadEntitiesCellFromMapDataPrincess("LivingStone_1", 3, 0);
        }
