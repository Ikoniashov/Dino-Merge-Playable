...
public class MatchRecipe
{
    ...
    {
        MatchRecipe.MatchRecipes.Add("Princess_Crimson_0", new MatchRecipe("Princess_Crimson_0", "Princess_Crimson_1_Root"));
        MatchRecipe.MatchRecipes.Add("Princess_Crimson_1_Root", new MatchRecipe("Princess_Crimson_1_Root", "Princess_Crimson_3_Root"));
        MatchRecipe.MatchRecipes.Add("Princess_Crimson_3_Root", new MatchRecipe("Princess_Crimson_3_Root", "Princess_Crimson_4_Root"));
    }
}
