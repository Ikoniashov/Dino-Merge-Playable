...
public class MatchRecipe
{
    ...
    {
        MatchRecipe.MatchRecipes.Add("LivingStone_1", new MatchRecipe("LivingStone_1", "LivingStone_2"));
        MatchRecipe.MatchRecipes.Add("LivingStone_2", new MatchRecipe("LivingStone_2", "LivingStone_3"));
        MatchRecipe.MatchRecipes.Add("LivingStone_3", new MatchRecipe("LivingStone_3", "LivingStone_4"));
        MatchRecipe.MatchRecipes.Add("LivingStone_4", new MatchRecipe("LivingStone_4", "Hero_Rainbow"));
    }
}
