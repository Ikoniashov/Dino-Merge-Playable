...
public class MatchRecipe
{
    ...
    {
        MatchRecipe.MatchRecipes.Add("GoldenSeeds", new MatchRecipe("GoldenSeeds", "Golden_Tree_1"));
        MatchRecipe.MatchRecipes.Add("Golden_Tree_1", new MatchRecipe("Golden_Tree_1", "Golden_Tree_5"));
        MatchRecipe.MatchRecipes.Add("Golden_Tree_5", new MatchRecipe("Golden_Tree_5", "Golden_Tree_10"));
        MatchRecipe.MatchRecipes.Add("Golden_Tree_10", new MatchRecipe("Golden_Tree_10", "Hero_MidasTree"));
    }
}
