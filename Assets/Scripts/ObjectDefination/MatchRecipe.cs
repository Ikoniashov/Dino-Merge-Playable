...
public class MatchRecipe
{
    ...
    {
        MatchRecipe.MatchRecipes.Add("Seed_FruitTree", new MatchRecipe("Seed_FruitTree", "Green_Tree_1"));
        MatchRecipe.MatchRecipes.Add("Green_Tree_1", new MatchRecipe("Green_Tree_1", "Green_Tree_2"));
        MatchRecipe.MatchRecipes.Add("Green_Tree_2", new MatchRecipe("Green_Tree_2", "Green_Tree_3"));
        MatchRecipe.MatchRecipes.Add("Green_Tree_3", new MatchRecipe("Green_Tree_3", "Green_Tree_4"));
        MatchRecipe.MatchRecipes.Add("Dreamflower_1", new MatchRecipe("Dreamflower_1", "Dreamflower_2"));
        MatchRecipe.MatchRecipes.Add("Dreamflower_2", new MatchRecipe("Dreamflower_2", "Dreamflower_3"));
        MatchRecipe.MatchRecipes.Add("Dreamflower_3", new MatchRecipe("Dreamflower_3", "Dreamflower_4"));
    }
}
