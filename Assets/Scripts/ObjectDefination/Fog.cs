...
public class Fog : MonoBehaviour
{
    ...
    public static void InitializePrefabInFogs_0()
    {
        ...
        {
            fogs[5][4].prefabName = "Treasure_Chest";
            fogs[5][3].prefabName = "Treasure_Chest";
            fogs[4][4].prefabName = "Treasure_Chest";
            fogs[4][3].prefabName = "Treasure_Chest";
            fogs[7][4].prefabName = "Treasure_Chest";
            for (int i = 0; i <= 3; i++)
            {
                for (int j = 0; j <= 4; j++)
                {
                    if (fogs[i][j] == null) Debug.Log(i + " " + j);
                    fogs[i][j].prefabName = "Treasure_Chest";
                }
            }
        }
        else
