...
public class ObjectForDraw : MonoBehaviour
{
    ...
    public virtual void Select()
    {
        ...
        if (this.Definition.PrefabName == "Hero_MidasTree" && this.addctiveObject != null)
        {
            GenerateAtPointAndSwoopToFreeCellPrincess("Fruit_GoldenApple1", addctiveObject.transform.position, true);
    ...
    {     
        ...
        if (cell != null)
        {
            ...
            if (cell.KeyObject != null)
            {
                ...
                {
                    if (anchor.XIndex == 6 && anchor.YIndex == 1) GameMgr.Instance.startClearFogs_0 = true;
                    else if (anchor.XIndex == 6 && anchor.YIndex == 3)
                    {
                ...
                {
                    if (anchor.XIndex == 2 && anchor.YIndex == 1)
                    {
                        GameMgr.Instance.startClearFogs_0 = true;
                    }
                    else if (anchor.XIndex == 3 && anchor.YIndex == 3)
                    {
                        GameMgr.gameOver = true;
                    }
                }
  ...
  //      if (this.Definition.TapBehavior != null)
    ...
    private void Start()
    {
        ...
        if (this.Definition.PrefabName == "Hero_MidasTree")
        {
            Transform locate = transform.Find("TapVisualizer");
            GameObject temp = GameMgr.GenerateFromPrefabAtPrincess("Fruit_GoldenApple1", this.transform.position);
