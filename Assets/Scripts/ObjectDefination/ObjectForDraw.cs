...
public class ObjectForDraw : MonoBehaviour
{
    ...
    public virtual void Select()
    {
        ...
        if (this.Definition.PrefabName == "Hero_MagicTome" && this.addctiveObject != null)
        {
            GenerateAtPointAndSwoopToFreeCellPrincess("Key_Cloud_Dungeon", addctiveObject.transform.position, true);
  ...
  //      if (this.Definition.TapBehavior != null)
    ...
    private void Start()
    {
        ...
        if (this.Definition.PrefabName == "Hero_MagicTome")
        {
            Transform locate = transform.Find("TapVisualizer");
            GameObject temp = GameMgr.GenerateFromPrefabAtPrincess("Key_Cloud_Dungeon", this.transform.position);
