...
public class ObjectForDraw : MonoBehaviour
{
    ...
    public virtual void Select()
    {
        ...
        if (this.Definition.PrefabName == "Hero_Rainbow" && this.addctiveObject != null)
        {
            GenerateAtPointAndSwoopToFreeCellPrincess("Life_Orb_4_Root", addctiveObject.transform.position, true);
  ...
  //      if (this.Definition.TapBehavior != null)
    ...
    private void Start()
    {
        ...
        if (this.Definition.PrefabName == "Hero_Rainbow")
        {
            Transform locate = transform.Find("TapVisualizer");
            GameObject temp = GameMgr.GenerateFromPrefabAtPrincess("Life_Orb_4_Root", this.transform.position);
