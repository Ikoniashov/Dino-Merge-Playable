...
public class MatchObjectDefinition
{
    ...
    public static void LoadMatchObjectDefinitionsPrincess()
    {
        ...
        MatchObjectDefinition._LoadRowBaseData("Hero_MagicTome");
        MatchObjectDefinition._LoadRowBaseData("Key_Cloud_Dungeon");
        MatchObjectDefinition._LoadRowBaseData("Treasure_Chest");
        MatchObjectDefinition._LoadRowBaseData("Treasure_Chest_2");
        MatchObjectDefinition._LoadRowBaseData("Treasure_Chest_3");
        MatchObjectDefinition._LoadRowBaseData("Treasure_Chest_5");
    }
