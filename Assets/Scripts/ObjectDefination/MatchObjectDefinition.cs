...
public class MatchObjectDefinition
{
    ...
    public static void LoadMatchObjectDefinitionsPrincess()
    {
        ...
        MatchObjectDefinition._LoadRowBaseData("GoldenSeeds");
        MatchObjectDefinition._LoadRowBaseData("Golden_Tree_1");
        MatchObjectDefinition._LoadRowBaseData("Golden_Tree_5");
        MatchObjectDefinition._LoadRowBaseData("Golden_Tree_10");
        MatchObjectDefinition._LoadRowBaseData("Hero_MidasTree");
        MatchObjectDefinition._LoadRowBaseData("Fruit_GoldenApple1");
    }
