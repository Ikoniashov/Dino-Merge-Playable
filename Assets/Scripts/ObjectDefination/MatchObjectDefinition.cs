...
public class MatchObjectDefinition
{
    ...
    public static void LoadMatchObjectDefinitionsPrincess()
    {
        ...
        MatchObjectDefinition._LoadRowBaseData("LivingStone_1");
        MatchObjectDefinition._LoadRowBaseData("LivingStone_2");
        MatchObjectDefinition._LoadRowBaseData("LivingStone_3");
        MatchObjectDefinition._LoadRowBaseData("LivingStone_4");
        MatchObjectDefinition._LoadRowBaseData("Hero_Rainbow");
        MatchObjectDefinition._LoadRowBaseData("Life_Orb_4_Root");
    }
