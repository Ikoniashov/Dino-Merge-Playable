...
public class MatchObjectDefinition
{
    ...
    public static void LoadMatchObjectDefinitionsPrincess()
    {
        ...
        MatchObjectDefinition._LoadRowBaseData("Seed_FruitTree");
        MatchObjectDefinition._LoadRowBaseData("Green_Tree_1");
        MatchObjectDefinition._LoadRowBaseData("Green_Tree_2");
        MatchObjectDefinition._LoadRowBaseData("Green_Tree_3");
        MatchObjectDefinition._LoadRowBaseData("Green_Tree_4");
        MatchObjectDefinition._LoadRowBaseData("Fog_Cloud");
        MatchObjectDefinition._LoadRowBaseData("Fruit_Peach");
        MatchObjectDefinition._LoadRowBaseData("Dreamflower_1");
        MatchObjectDefinition._LoadRowBaseData("Dreamflower_2");
        MatchObjectDefinition._LoadRowBaseData("Dreamflower_3");
        MatchObjectDefinition._LoadRowBaseData("Dreamflower_4");
    }
