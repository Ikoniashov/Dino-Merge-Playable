...
public class TutorialHand : MonoBehaviour
{
    ...
    private bool IsOnScreen(Vector3 a_worldPosition)
    {
    ...
    private void PlayTapAnimation(Vector3 a_position)
    {
        KillSequence();
    ...
    private void PlayDragAnimation(Vector3 a_from, Vector3 a_to, bool a_escalated)
    {
        KillSequence();
    ...
    private void PlayHoldAnimation(Vector3 a_position)
    {
        KillSequence();
